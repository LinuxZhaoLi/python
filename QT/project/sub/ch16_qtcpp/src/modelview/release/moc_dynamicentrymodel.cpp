...
void DynamicEntryModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        DynamicEntryModel *_t = static_cast<DynamicEntryModel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (DynamicEntryModel::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DynamicEntryModel::countChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject DynamicEntryModel::staticMetaObject = {
    { &QAbstractListModel::staticMetaObject, qt_meta_stringdata_DynamicEntryModel.data,
      qt_meta_data_DynamicEntryModel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *DynamicEntryModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DynamicEntryModel.stringdata0))
        return static_cast<void*>(const_cast< DynamicEntryModel*>(this));
